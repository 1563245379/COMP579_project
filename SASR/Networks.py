...
class CNNFeatureExtractor(nn.Module):
    ...
    def __init__(self, in_channels=4, new_version=True):
        super().__init__()
        if new_version:
        ...
        self.fc = nn.Linear(3136, 512) if new_version else nn.Linear(20736, 512)
...
class SACActorDiscrete(nn.Module):
    ...
    def __init__(self, env, new_version=True):
        super().__init__()
        in_channels = env.observation_space.shape[0]
        self.num_actions = env.action_space.n
        self.feature_extractor = CNNFeatureExtractor(in_channels, new_version=new_version)
...
class PPOActorCriticDiscrete(nn.Module):
    ...
    def __init__(self, env, new_version=True):
        ...
        in_channels = env.observation_space.shape[0]
        self.num_actions = env.action_space.n
        self.features = CNNFeatureExtractor(in_channels, new_version=new_version)
